        ...
        {
            {
                ...
                if (choose == "2")
                {
                    ...
                    {
                        mc.Heal();
                        Console.WriteLine($"Вы нашли лечебное зелье! Ваше здоровье равно {mc.Health}!\n");
                    }
                    else
                    {
                        Console.WriteLine($"Вы нашли потайной проход и попали в третью комнату!\n В ней вас поджидает {enemy.Name}! Нажмите любую клавишу, чтобы принять бой...\n");
                        Console.ReadKey(true);
                        while (mc.Health > 0 && enemy.Health > 0)
                        {
                            mc.Hit(enemy, mc_wp);
                        ...
                        enemy.Heal();
                        Console.WriteLine($"Вы победили! У вас осталось {mc.Health} здоровья.");
                        Console.WriteLine("Выберите действие: \n1 - обыскать правый сундук \n2 - обыскать левый сундук\n");
                        choose = Console.ReadLine();
                        while (choose != "1" && choose != "2")
                        {
                            Console.WriteLine("Введите ответ корректно\n");
                        ...
                        if (choose == "2")
                        {
                            Console.WriteLine("Вы попались в смертельную ловушку и погибли!");
                            return;
                        }
                        else
                        {
                            ...
                            key = true;
                            Console.WriteLine("Нажмите любую клавишу, чтобы вернуться в первую комнату...");
                            Console.ReadKey(true);
                            Console.WriteLine();
                        }
                    }
